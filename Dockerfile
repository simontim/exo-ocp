...
#RUN mkdir -p ${EXO_DATA_DIR}         && chown ${EXO_USER}:0 ${EXO_DATA_DIR} && \
#    mkdir -p ${EXO_SHARED_DATA_DIR}  && chown ${EXO_USER}:0 ${EXO_SHARED_DATA_DIR} && \
#    mkdir -p ${EXO_TMP_DIR}          && chown ${EXO_USER}:0 ${EXO_TMP_DIR}  && \
#    mkdir -p ${EXO_LOG_DIR}          && chown ${EXO_USER}:0 ${EXO_LOG_DIR}
